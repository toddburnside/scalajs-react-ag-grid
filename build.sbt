...
inThisBuild(
  List(
    ...
    homepage := Some(
      url("https://github.com/rpiaggio/scalajs-react-ag-grid")
    ),
    licenses := Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/rpiaggio/scalajs-react-ag-grid"),
        "scm:git:git@github.com:rpiaggio/scalajs-react-ag-grid.git"
      )
    )
  )
)
...
lazy val facade =
  project
    ...
    .settings(
      name := "facade",
      moduleName := "scalajs-react-ag-grid",
